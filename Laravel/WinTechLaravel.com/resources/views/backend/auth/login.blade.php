      ...
      <div class="card login-card">
        <div class="row no-gutters content-login">
          <div class="col-md-5 img-login slider">
            <div class="list">
              <div class="item">
                <img src="../../../../resources/img/login.JPG" alt="login" class="login-card-img">
              </div>
              <div class="item">
                <img src="../../../../resources/img/login2.JPG" alt="login" class="login-card-img">
              </div>
              <div class="item">
                <img src="../../../../resources/img/login3.JPG" alt="login" class="login-card-img">
              </div>
            </div>
            <!-- Dots -->
            <ul class="dots">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('auth.login') }}">
                @csrf
                  ...
                  <button name="login" id="login" class="btn btn-block login-btn  w-100"  value="Login" type="submit">Login</button>
